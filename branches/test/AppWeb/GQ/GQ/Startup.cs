    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, IServiceProvider svp)
        {
            try
            {
                ...
                GQService.com.gq.security.SecurityConfigure.Configure(TimeSpan.FromMinutes(360), Security.hasPermission, new Type[] { typeof(LoginController) /*, typeof(MovileController)*/ });
